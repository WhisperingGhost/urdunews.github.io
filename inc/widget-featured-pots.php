...
class upress_featured_posts_widget extends WP_Widget
{
    ...
    public function __construct()
    {
        $widget_details = array(
            ...
            'description' => 'Posts That Have Higher Views Count'
        );
 
        parent::__construct( 'upress_featured_posts_widget', 'ST - Popular Posts', $widget_details );
    ...
    ?>
    	<div id="upress-<?php echo $this->id ?>" class="widget upress-views-posts">
